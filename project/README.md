...
The project project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=project -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3 -DgroupId=com.changr -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd project
$ mvn clean package
